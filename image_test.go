...
var validCases = []struct {
...
}{
	{
		...
		&image{filename: "foo.gif", content: "AA==", content_type: "image/gif", embedded: true},
	}, {
		...
		&image{filename: "foo.jpg", content: "AA==", content_type: "image/jpeg", embedded: true},
	}, {
		`1337: handles width & height`,
		"1337;File=name=foo.jpg;width=100%;height=50px;inline=1:AA==",
		&image{filename: "foo.jpg", content: "AA==", content_type: "image/jpeg", width: "100%", height: "50px", embedded: true},
	}, {
		...
		&image{filename: "foo.gif", content: "AA==", content_type: "image/gif", width: "100%", height: "50px", embedded: true},
	}, {
		`1337: converts width & height without percent or px to em`,
		"1337;File=name=foo.jpg;width=1;height=5;inline=1:AA==",
		&image{filename: "foo.jpg", content: "AA==", content_type: "image/jpeg", width: "1em", height: "5em", embedded: true},
	}, {
