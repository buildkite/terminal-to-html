...
BUILDCMD=CGO_ENABLED=0 go build -trimpath -ldflags="-s -w" -o $@ ./cmd/terminal-to-html
...
GZ_ARCH     := linux-amd64 linux-i386 linux-armel linux-arm64 darwin-amd64 darwin-arm64
