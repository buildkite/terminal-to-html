...
func assets_terminal_css() (*asset, error) {
	...
	info := bindata_file_info{name: "assets/terminal.css", size: 8973, mode: os.FileMode(420), modTime: time.Unix(1424840315, 0)}
